...
class DiscreteUniformTransition:
    def __init__(self, x_classes: int, e_classes: int, y_classes: int, directed: bool):
    ...
    def get_Qt(self, beta_t, device):
        ...
        return utils.PlaceHolder(X=q_x, E=q_e, y=q_y, directed=self.directed)
...
class MarginalUniformTransition:
    def __init__(self, x_marginals, e_marginals, y_classes, directed):
