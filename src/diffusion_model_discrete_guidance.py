...
class DiscreteDenoisingDiffusion(pl.LightningModule):
    def __init__(self, cfg, dataset_infos, train_metrics, sampling_metrics, visualization_tools, extra_features,
        ...
        if cfg.model.transition == 'uniform':
            ...
            self.limit_dist = utils.PlaceHolder(X=x_limit, E=e_limit, y=y_limit, directed=self.directed)
    ...
    def reconstruction_logp(self, t, X, E, y, node_mask):
        ...
        sampled0 = diffusion_utils.sample_discrete_features(probX=probX0, probE=probE0, node_mask=node_mask, directed=self.directed)
        ...
        sampled_0 = utils.PlaceHolder(X=X0, E=E0, y=y0, directed=self.directed).mask(node_mask)
        ...
        return utils.PlaceHolder(X=probX0, E=probE0, y=proby0, directed=self.directed)
    ...
    def sample_batch(self, batch_id: int, batch_size: int, keep_chain: int, number_chain_steps: int,
        ...
        if self.visualization_tools is not None:
            ...
            self.visualization_tools.visualize(result_path, predicted_graph_list, save_final, log='predicted', directed=self.directed)
            print("Done.")
    ...
    def sample_p_zs_given_zt(self, t, X_t, E_t, y_t, node_mask, last_step: bool):
        ...
        if last_step:
            predicted_graph = diffusion_utils.sample_discrete_features(pred_X, pred_E, node_mask=node_mask, directed=self.directed)
