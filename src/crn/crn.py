...
class CRN:
    ...
    def __init__(self, reactions, initial_concentrations=None, reduced_reactions=True):
    ...
    @staticmethod
    def from_signature(signature, reduced_reactions=True):
        ...
        return CRN(reactions, reduced_reactions=reduced_reactions)
        ...
        for reaction in self.reactions:
            if reaction.catalyst is None:
                ...
                if reaction.catalyst == reaction.reactants[0]:
                    mr2.add_metabolites({self.mass_metabolites[reaction.reactants[0]]: 1})
                    mr2.add_metabolites({self.mass_metabolites[reaction.products[0]]: reaction.stoichiometry[1]})

                elif reaction.catalyst == reaction.products[0]:
